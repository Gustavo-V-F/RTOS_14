...
osThreadId Handler_handle;
osThreadId Periodic_handle;
osSemaphoreId xCounting_semaphore_handle;
/* USER CODE BEGIN PV */
...
void vHandler_task(void const * argument);
...
int main(void)
{
  ...
  /* definition and creation of xCounting_semaphore */
  osSemaphoreDef(xCounting_semaphore);
  xCounting_semaphore_handle = osSemaphoreCreate(osSemaphore(xCounting_semaphore), 10);
...
/* USER CODE BEGIN Header_vHandler_task */
/**
* @brief Function implementing the Handler thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_vHandler_task */
void vHandler_task(void const * argument)
{
  /* USER CODE BEGIN vHandler_task */
  /* Infinite loop */
  for(;;)
  {
    osSemaphoreWait(xCounting_semaphore_handle, osWaitForever);
...
void vPeriodic_task(void const * argument)
{
  /* USER CODE BEGIN vPeriodic_task */
  /* Infinite loop */
  for(;;)
  {
    osDelay(500);
